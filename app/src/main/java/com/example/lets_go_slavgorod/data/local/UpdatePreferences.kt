...
class UpdatePreferences(private val context: Context) {
     ...
     */
    val autoInstallEnabled: Flow<Boolean> = context.updatePreferencesDataStore.data
        .map { preferences ->
            preferences[UpdatePreferencesKeys.AUTO_INSTALL_ENABLED] ?: false
        }
    ...
    suspend fun setAutoInstallEnabled(enabled: Boolean) {
        context.updatePreferencesDataStore.edit { preferences ->
            preferences[UpdatePreferencesKeys.AUTO_INSTALL_ENABLED] = enabled
        }
    }
