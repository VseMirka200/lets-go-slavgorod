        ...
        Column(
            ...
            val routeFavoriteTimes by remember {
                derivedStateOf {
                    ...
                    Timber.d("RouteNotificationSettings: allFavoriteTimes count = ${allFavoriteTimes.size}")
                    Timber.d("RouteNotificationSettings: route.id = ${route.id}")
                    Timber.d("RouteNotificationSettings: filtered routeFavoriteTimes count = ${filtered.size}")
                    filtered.forEach { entity ->
                        Timber.d("RouteNotificationSettings: favoriteTime = $entity")
                    }
                    filtered
                }
            }
            ...
            val nextNotificationTime = remember(
                ...
                val convertedTimes = routeFavoriteTimes.mapNotNull { entity ->
                    try {
                        ...
                        Timber.d("RouteNotificationSettings: converted favoriteTime = $favoriteTime")
                        favoriteTime
                    } catch (e: Exception) {
                ...
                Timber.d("RouteNotificationSettings: calculated nextNotificationTime = $result")
                Timber.d("RouteNotificationSettings: convertedTimes count = ${convertedTimes.size}")
                Timber.d("RouteNotificationSettings: currentNotificationMode = $currentNotificationMode")
                Timber.d("RouteNotificationSettings: selectedDays = $selectedDays")
                Timber.d("RouteNotificationSettings: leadTime = $leadTime")
            ...
            Timber.d("RouteNotificationSettings: routeFavoriteTimes count = ${routeFavoriteTimes.size}")
            Timber.d("RouteNotificationSettings: nextNotificationTime = $nextNotificationTime")
            ...
            if (routeFavoriteTimes.isNotEmpty()) {
                Column(
                    ...
                    NextNotificationTimer(
                        ...
                        notificationMode = currentNotificationMode.name,
