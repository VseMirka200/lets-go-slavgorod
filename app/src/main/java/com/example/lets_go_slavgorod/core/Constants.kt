 ...
 * 
 * Изменения v3.0:
 * - Добавлены константы для виджетов (WIDGET_UPDATE_INTERVAL_MINUTES)
 * - Добавлены константы для производительности (ROUTES_MAX_CACHE_SIZE)
 * - Оптимизированы интервалы обновления для экономии батареи
 * - Добавлены лимиты кэша для предотвращения утечек памяти
 * 
