 ...
 * 
 * Предоставляет статические методы для генерации и обработки расписаний
 * всех маршрутов приложения "Поехали! Славгород". Содержит актуальные
 * данные о времени отправления, маршрутах и остановках.
 * 
 * Архитектура:
 * - Object с статическими методами для глобального доступа
 * - Типизированные данные через data classes
 * - Валидация данных при генерации
 * - Поддержка различных дней недели и выходов
 * 
 * Основные функции:
 ...
 * 
 * Особенности:
 * - Thread-safe статические методы
 ...
 * 
 * Маршруты:
 * - **№102**: Славгород — Яровое (основной маршрут)
 * - **№1**: Вокзал — Совхоз (городской маршрут)
...
object ScheduleUtils {
    ...
    /**
     * Генерирует упрощенное расписание для маршрута №102Б (Славгород — Яровое через Ст. Зори)
